...
- [x] **VULN-03**: Query OSV.dev for open-source vulnerability data
- [x] **VULN-04**: Integrate SearchSploit local exploit database
...
- [x] **VULN-07**: Local caching to avoid re-querying known services

### Output

- [x] **OUT-01**: Generate Obsidian vault with `[[wikilinks]]` for native graph view
- [x] **OUT-02**: Hierarchical node structure: Project → IP Addresses → Ports/Services
- [x] **OUT-03**: YAML frontmatter with severity, tags, and service metadata
- [x] **OUT-04**: Severity classification (critical/high/medium/low) with Obsidian tags
